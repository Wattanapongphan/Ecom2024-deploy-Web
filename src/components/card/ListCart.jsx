        ...
        <div className='bg-gray-100 rounded-md p-4'>
            ...
            <div>
                ...
                <div className='grid grid-cols-1  md:grid-cols-3 gap-4 '>
                    ...
                    {/* Right */}
                    <div className='bg-white rounded-md p-4 shadow-md space-y-4'>
                        ...
                        <div className='flex flex-col gap-2'>
                         ...
                         text-white py-2 shadow-md hover:bg-red-600'>สั่งซื้อ</button>
                                    </Link>
                                    : <Link to={'/login'}>
                                        <button className='bg-blue-500 w-full rounded-md
                         text-white py-2 shadow-md hover:bg-blue-600'>Login</button>
                                    </Link>
                         ...
                         text-white py-2 shadow-md hover:bg-gray-600'>แก้ไขรายการ</button>
                            </Link>
                        </div>
                    </div>
                </div>
